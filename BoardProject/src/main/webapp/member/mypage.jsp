                ...
                <div class="row justify-content-center">
                    <div class="col-6">
                        ...
                        <form action="/member/modify.member" id="modifyForm" method="post">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="zipcode" id="zipcode" type="text" class="form-control" value="${member.zipcode}"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="address1" id="address1" type="text" class="form-control" value="${member.address1}"
                                            aria-label="Username" aria-describedby="basic-addon1" placeholder="(선택)"
                                            readonly>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="address2" id="address2" type="text" class="form-control" value="${member.address2}"
                            ...
                            <div class="row">
                                <div class="col-6 text-end"><button type="submit" class="btn btn-primary">수정하기</button>
                                </div>
                                <div class="col-6 text-start"><button id="rollbackBtn" type="button" class="btn btn-primary">초기화</button>
                                    <script>
